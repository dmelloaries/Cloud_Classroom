...
function TeacherDashboard() {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(
          `${import.meta.env.VITE_BACKEND_URL}/api/teacher/dashboard`,
          {
            method: "GET",
            headers: {
  ...
  const menuItems = ["Classrooms", "Create Timetable", "Timetables"];
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {selectedOption !== "Classrooms" && (
          <Typography variant="body1" className="mt-4">
            Welcome to the teacher's dashboard. Please select an option from the
            sidebar.
          </Typography>
        )}
      </Box>
